    ...
    <div className="pt-24 pb-20 bg-slate-50 dark:bg-slate-950 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-8">
          <Link to="/" className="hover:text-indigo-600 dark:hover:text-emerald-400 transition-colors">Home</Link>
          <ChevronRight size={14} />
          <Link to="/marketplace" className="hover:text-indigo-600 dark:hover:text-emerald-400 transition-colors">Products</Link>
          <ChevronRight size={14} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <motion.div 
            ...
            className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 overflow-hidden p-8 shadow-xl shadow-slate-200/50 dark:shadow-none"
          >
            <div className="aspect-[4/3] bg-indigo-600 dark:bg-indigo-950/60 rounded-[2rem] flex items-center justify-center p-12 overflow-hidden shadow-inner">
               <img 
          ...
          >
            <span className="inline-block px-4 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-emerald-400 text-xs font-bold uppercase tracking-wider mb-6 w-fit border border-indigo-100 dark:border-indigo-900">
              {product.category}
            </span>
            ...
            <div className="flex items-center gap-4 mb-8">
               <span className="text-3xl font-display font-extrabold text-indigo-600 dark:text-emerald-400 tracking-tight">
                 {currency}{(product.price ?? 0).toLocaleString()}
               </span>
               <div className="h-4 w-px bg-slate-200 dark:bg-slate-800 md:block hidden" />
               <div className="flex items-center gap-1 text-green-600 dark:text-emerald-400 text-sm font-bold">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none mb-12">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8 list-none p-0">
                {(product.features || [
                  ...
                  <li key={i} className="flex items-center gap-3 text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 rounded-2xl shadow-sm">
                    <div className="w-6 h-6 bg-green-100 dark:bg-emerald-950/80 text-green-600 dark:text-emerald-400 rounded-lg flex items-center justify-center shrink-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              <Link
                ...
                className="flex-1 bg-indigo-600 text-white px-10 py-5 rounded-[1.25rem] font-bold text-xl hover:bg-slate-950 dark:hover:bg-emerald-500 transition-all shadow-2xl shadow-indigo-500/20 flex items-center justify-center gap-3"
              >
              ...
              <button 
                onClick={() => navigate(-1)}
                className="px-8 py-5 border-2 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-300 rounded-[1.25rem] font-bold hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-2"
              >
                <ArrowLeft size={20} />
                Back
              </button>
