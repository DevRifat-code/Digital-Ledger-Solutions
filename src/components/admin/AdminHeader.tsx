    ...
    <header className="h-20 bg-white border-b border-slate-200 sticky top-0 z-40 flex items-center justify-between px-4 md:px-8">
      <div className="flex items-center gap-4">
        ...
        <button 
          ...
          className="p-2.5 text-slate-600 hover:text-indigo-600 hover:bg-slate-100 rounded-xl transition-all border border-slate-200 flex items-center gap-2 shadow-sm"
          title={isSidebarOpen ? "Hide Sidebar (সাইডবার লুকান)" : "Show Sidebar (সাইডবার দেখান)"}
